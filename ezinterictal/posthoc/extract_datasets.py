...
def save_trimmed_slices(result, trim_length, deriv_path, start=10, verbose=True):
    # hack to accommodate earlier derivatives computed
...
if __name__ == "__main__":
    ...
    for feature_name in featuremodels:
        ...
        interictal_results = load_all_interictal_derivatives(
        ...
        for result in interictal_results:
            save_trimmed_slices(
                result, trim_length=trim_length, deriv_path=pub_data_dir, start=10
            )
